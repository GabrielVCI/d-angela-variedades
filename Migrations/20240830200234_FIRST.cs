    ...
    public partial class FIRST : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_Categorias", x => x.IdCategoria);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdminEmpresaId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_Empresas", x => x.IdEmpresa);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_SubCategorias", x => x.IdSubCategoria);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdCategoria = table.Column<int>(type: "int", nullable: false),
                    SubcategoriaIdSubCategoria = table.Column<int>(type: "int", nullable: false),
                    IdSubCategoria = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_Producto", x => x.IdProducto);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Productos_Subategorias_SubcategoriaIdSubCategoria",
                        column: x => x.SubcategoriaIdSubCategoria,
                        principalTable: "Subategorias",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cod_Venta = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Desc_Prod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PrimaryKey_Ventas", x => x.IdVenta);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productos_SubcategoriaIdSubCategoria",
                table: "Productos",
